...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animateT.displayTextWithAnimation(getString(R.string.dipinfo));
    ...
    public void glideimg()
    {
        ...
        Glide.with(this).load(R.drawable.dip).into(imageViewTarget);
    }
                    ...
                    handler.post(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            if (pStatus==20)
                            {
                                ...
                                animateT.setText("");
                                animateT.setCharacterDelay(120);
                                animateT.displayTextWithAnimation(getString(R.string.sideinfo));
