...
{
    private static int SPLASH_TIME_OUT = 61880;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animateT.displayTextWithAnimation(getString(R.string.frontexample));
    ...
    public void glideimg()
    {
        ...
        Glide.with(this).load(R.drawable.frontsquat).into(imageViewTarget);
    }
                    ...
                    handler.post(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            if (pStatus==20)
                            {
                                ...
                                animateT.setText("");
                                animateT.setCharacterDelay(120);
                                animateT.displayTextWithAnimation(getString(R.string.dip));

                                imgv.setImageResource(R.drawable.dip);
